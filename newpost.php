...
if(isset($_POST['submit'])){
  ...
  echo "This is a test ".$category;
  $sql='INSERT INTO post(datetime,title,category,author,image,post)';
  $sql.='VALUES(:datetime,:title,:category,:author,:imagename,:postdesc)';
  ...
  $stmt->bindValue(':postdesc',$post);
  $execute=$stmt->execute();
  move_uploaded_file($_FILES['image']['tmp_name'], $target);
  if($execute){
    $_SESSION['SuccessMessage']='Post with id: '.$ConnectingDB->lastInsertId().' Added Successfully '.$title;
      redirect_to('newpost.php');
  }
  else {
          ...
          <div class="card-header">
            ...
            <div class="card-body bg-dark">
              ...
              <div class="form-group">
                ...
                <textarea class='form-control'id='post' name="postdesc" rows="8" cols="80"></textarea>
